...
**407 canonical components** in this framework.
...
- Svelte 5 implementation of all 407 components from `components.tsv`.
...
- [ ] All 407 directories are mirrored under `src/lib/components/{PascalCase}/`.
