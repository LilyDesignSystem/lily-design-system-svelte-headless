<script lang="ts">
    ...
    //
    // Syntax:
    //   <SouthAfricaIdentityNumberInput label="South African Identity Number" bind:value />
    //
    // Accessibility:
...
<!-- SouthAfricaIdentityNumberInput.svelte -->
<input
    class={`south-africa-identity-number-input ${className}`}
    type="text"
    aria-label={label}
    autocomplete="off"
    bind:value
