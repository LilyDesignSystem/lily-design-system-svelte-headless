...
import Subject from "./ChileRolUnicoNacionalInput.svelte";
...
describe("ChileRolUnicoNacionalInput", () => {
    ...
    test("can be set to required", () => {
        render(Subject, { props: { label: "Rol Único Nacional (RUN)", required: true } });
    ...
    test("can be set to disabled", () => {
        render(Subject, { props: { label: "Rol Único Nacional (RUN)", disabled: true } });
    ...
    test("passes through additional HTML attributes", () => {
        render(Subject, { props: { label: "Rol Único Nacional (RUN)", "data-testid": "subject" } });
