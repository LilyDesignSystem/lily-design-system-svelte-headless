# Lily Design System — Svelte Headless — Implementation Plan

## Goal

Implement all headless components using Svelte 5 with runes + TypeScript. Every component must be headless (zero CSS), fully accessible (WCAG 2.2 AAA), and have comprehensive tests.
...
- Component file extension: .svelte
